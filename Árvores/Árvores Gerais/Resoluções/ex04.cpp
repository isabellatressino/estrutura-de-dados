/*Considere uma arvore. Construir uma função que recebe o endereço do no raiz e conta quantos nos dessa arvore possui todos os descendentes. Isto é, nunhum de seus links é null.*/
...
int contar_nos_completos(no_arv *raiz, int grau){
    queue_element v;
    Queue Q;
    initQueue(Q);
...
int main(){
    ...
    int cont = contar_nos_completos(raiz,grau);

    cout << "\nQuantidade de nos completos " << cont;
